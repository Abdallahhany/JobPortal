...
public class JobPostActivity {
    ...
    // @ManyToOne annotation is used to create a many-to-one relationship between two entities.
    // @JoinColumn annotation is used to specify the foreign key column in the owner entity.
    // referencedColumnName attribute is used to specify the primary key column of the target entity.
    @ManyToOne
    @JoinColumn(name = "postedById", referencedColumnName = "userId")
    private Users postedById;

    //CascadeType.ALL means that if the parent entity is updated, then the changes are cascaded to the child entity.
    ...
    // @Transient annotation is used to specify that the property or field is not persistent.
    @Transient
