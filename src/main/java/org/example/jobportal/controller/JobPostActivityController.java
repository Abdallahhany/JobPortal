...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
        ...
        // Determine the search date based on the selected filters
        ...
        // Set default values for the filters if they are not selected
        ...
        // fetch the job posts based on the selected filters
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                // Check if the job is already applied or saved by the user
